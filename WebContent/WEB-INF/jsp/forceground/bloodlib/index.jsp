			...
			<div style="width:70%;height:100%;float:left;">
				...
				<div style="width:75%;height:60%;float:left;">
					<div class="panel" style="width:100%;height: 60%;">
						<div class="panel-heading" style="height:50px;"><span class="panel-title" style="float:left"><h3>本库需血信息:</h3></span><span style="float:right;padding-bottom: 10px"><a>更多+<a></a></span></div>
					...
					<div class="panel" style="width:100%;height: 40%;">
						<div class="panel-heading" style="height:50px;"><span class="panel-title" style="float:left"><h3>本库血液存余血量:</h3></span></div>
						<div class="panel-body" style="height:310px;border: none">
					...
					<div class="panel" style="width:100;height:100%">
						...
						<div class="panel-body" style="height:310px;border: none">
							...
							<div style="width:100%;height:70px">
								<div style="padding: 5px">
									<div style="width:50%;float: left">
										<button class="btn btn-circle" id="id_bs_my"><h6 style="color:#FFFFFF">我的血液<br>存量</h6></button>
									</div>
									<div style="width:50%;float: left">
