					...
					<div class="navbar-header">
						...
						<div class="btn-group" style="padding-top: 5px">
  							...
  							<ul class="dropdown-menu" style="background-color: #d9534f">
    							...
    							<li><a href="#" id="">退出登陆</a></li>
  							</ul>
						</div>
					</div>
					<div>
						<ul class="nav navbar-nav navbar-right">
						  <li><a href="#" id="id_btn_firstpage"><h4 style="color: #FFFFFF;font-size: 16px;">首页</h4></a></li>
						  <li><a href="#" id="id_btn_nb"><h4 style="color: #FFFFFF;font-size: 16px;">需血信息</h4></a></li>
						  <li><a href="#" id="id_btn_mybt"><h4 style="color: #FFFFFF;font-size: 16px;">我的血型信息</h4></a></li>
						  <li><a href="#" id="id_btn_nearhospital"><h4 style="color: #FFFFFF;font-size: 16px;">附近的医院</h4></a></li>
						  <li><a href="#" id="id_btn_nearbloodlib"><h4 style="color: #FFFFFF;font-size: 16px;">附近的血库</h4></a></li>
						</ul>
					</div>
				</div>
			</nav>
