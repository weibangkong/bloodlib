	...
	<div style="width:100%;height:100%;position: absolute;">
		...
		<div style="width:100%;height:130%;">
			...
			<div style="width:70%;height:100%;float:left;">
							...
							<td style="width:40%">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="text" class="form-control" id="needBleedPerson" name="needBleedPerson">
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<td class="data_td">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<!-- <input type="text" class="form-control" id="certificateType" name="certificateType"> -->
				...
				<div align="center">
					<button class="btn btn-primary" id="id_btn_publish">发布</button>
					<button class="btn btn-primary" id="id_btn_reset">清空</button>
					<button class="btn btn-primary" id="id_btn_auto">使用我的信息</button>
				</div>
			</div>
			<!-- 右侧空白 -->
			<div style="width:15%;height:100%;float:left;background-color: #DDDDDE"></div>
...
$('#id_btn_publish').click(function(){
	...
	$.when($.post('${pageContext.request.contextPath}/app/needblood/insert/formal',data)).done(function(data){
